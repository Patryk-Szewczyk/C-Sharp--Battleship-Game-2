...
namespace Page_Options
{
    ...
    interface IPageOptions   // Mog³em opuœciæ interfejs, aby mieæ metody statyczne, ale u¿ywam go poniewa¿ chcê mieæ widoczne na górze nazwy wszystkich metody danej klasy:
    {
        void Options();   // Wyœwietlenie strony rankingu.
    }
